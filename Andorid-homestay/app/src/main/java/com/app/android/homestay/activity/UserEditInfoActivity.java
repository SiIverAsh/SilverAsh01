...
//                        });
                ...
                PictureSelector.create(UserEditInfoActivity.this).openGallery(SelectMimeType.ofImage()).setSelectionMode(SelectModeConfig.SINGLE).setImageEngine(GlideEngine.createGlideEngine()).setSandboxFileEngine(new UriToFileTransformEngine() {
                    @Override
                    ...
                    public void onResult(ArrayList<LocalMedia> result) {
                        ...
                        GlideEngine.createGlideEngine().loadImage(UserEditInfoActivity.this, localMedia.getAvailablePath(), profile_image);
                    }
